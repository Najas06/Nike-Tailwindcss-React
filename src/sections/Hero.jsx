...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <div className="relative flex-1 flex justify-center items-center xl:min-h-screen max-xl:py-40 bg-primary bg-hero bg-cover bg-contain">
        <img 
        src={bigShoeImg} 
        alt="shoe collection"
        width={620}
        ...
        />
        <div className="flex sm:gap-6 gap-4 absolute -bottom-5 sm:left-[12%] max-sm:px-6">
           {
            shoes.map((shoe)=>(
              <div key={shoe}>
                <ShoeCard 
